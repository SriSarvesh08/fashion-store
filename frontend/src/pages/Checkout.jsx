      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <div className="card p-6">
            ...
            <div className="w-full flex items-center gap-4 p-4 rounded-xl border-2 border-blush-500 bg-blush-50">
              <div className="w-4 h-4 rounded-full border-2 border-blush-500 flex items-center justify-center">
